...
CREATE UNIQUE INDEX IF NOT EXISTS idx_cognitive_categories_id ON cognitive_categories (id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_cognitive_functions_id ON cognitive_functions (id);
